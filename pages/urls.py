...
urlpatterns = [
    ...
    path('employee/hr/onboarding/pdf/tasks/<uuid:task_id>/download/', views_onboarding_hr.download_onboarding_pdf_submission, name='download_onboarding_pdf_submission'),
    ...
    path('onboarding/pdf/<uuid:task_id>/upload/', views_onboarding_portal.upload_onboarding_pdf, name='onboarding_pdf_upload'),
    path('onboarding/pdf/<uuid:task_id>/submission/', views_onboarding_portal.download_onboarding_pdf_submission, name='onboarding_pdf_submission_download'),
    ...
    path('employee/tax/templates/<uuid:template_id>/add-section/', views_tax.add_form_section, name='add_tax_form_section'),
    path('employee/tax/templates/<uuid:template_id>/delete/', views_tax.delete_tax_form_template, name='delete_tax_form_template'),
    path('employee/tax/sections/<uuid:section_id>/edit/', views_tax.edit_form_section, name='edit_tax_form_section'),
    path('employee/tax/sections/<uuid:section_id>/delete/', views_tax.delete_form_section, name='delete_tax_form_section'),
    path('employee/tax/sections/reorder/', views_tax.reorder_sections, name='reorder_tax_form_sections'),
    path('employee/tax/fields/<uuid:field_id>/', views_tax.get_form_field, name='get_tax_form_field'),
    path('employee/tax/fields/<uuid:field_id>/update/', views_tax.update_form_field, name='update_tax_form_field'),
    path('employee/tax/fields/<uuid:field_id>/delete/', views_tax.delete_form_field, name='delete_tax_form_field'),
    path('employee/tax/fields/<uuid:field_id>/move/', views_tax.move_field_to_section, name='move_field_to_section'),
